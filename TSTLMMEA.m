            ...
            while Algorithm.NotTerminated(Population)
                ...
                if ~netInitialized || gen < 0.2 * MaxGen
                    ...
                    if gen>0.5*maxgen
                        ...
                        Offspring2 = Problem.Evaluation(OperatorGA(Problem,V(MatingPool2,:)));
                    else
                        Fitness2 = CalFitnessSup(net.w,Population.decs);
                        MatingPool2 = TournamentSelection(2,Problem.N,-Fitness2);
                        Offspring2  = OperatorGA(Problem,V(MatingPool2));
                    end
